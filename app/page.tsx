        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-[#E8E0D4]/60 bg-[#FDF8F0] px-4 py-4 space-y-3">
            ...
            <div className="pt-3 border-t border-[#E8E0D4]/60 space-y-2">
              ...
              <Link href="/register" className="block text-center text-sm font-semibold bg-[#1A1A2E] text-white px-5 py-2.5 rounded-full">
                Jetzt starten
              </Link>
            </div>
          </div>
      ...
      <section className="relative px-4 pt-16 sm:pt-24 pb-12 sm:pb-16 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-[#E8E0D4] rounded-full text-sm mb-8 shadow-sm">
            ...
            <Link href="/register" className="text-[#1A1A2E] font-medium hover:underline">&rarr;</Link>
          </div>
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl shadow-black/8 border border-[#E8E0D4]/80 overflow-hidden">
              ...
              <div className="border-t border-[#F0EBE2] px-4 py-3 bg-white">
                <div className="flex gap-2">
                  ...
                  <Link href="/register" className="px-4 py-3 bg-[#F5B731] hover:bg-[#E8930C] rounded-xl transition-colors flex items-center">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <Link href="/register" className="inline-flex items-center gap-2 mt-8 px-6 py-3 bg-[#1A1A2E] text-white font-semibold rounded-full hover:bg-[#2D2D44] transition-colors text-sm">
                Jetzt ausprobieren
          ...
          <div className="bg-gradient-to-br from-[#1A1A2E] to-[#2D2D44] rounded-3xl px-8 sm:px-16 py-14 sm:py-20 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <Link href="/register" className="w-full sm:w-auto text-center px-8 py-3.5 bg-[#F5B731] text-[#1A1A2E] font-semibold rounded-full hover:bg-[#E8930C] transition-colors text-sm shadow-lg shadow-[#F5B731]/20">
                  Kostenlos starten
                </Link>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                ...
                <li><Link href="/register" className="text-sm text-[#6B7280] hover:text-[#1A1A2E] transition-colors">Job-Suche starten</Link></li>
              </ul>
            </div>
            <div>
